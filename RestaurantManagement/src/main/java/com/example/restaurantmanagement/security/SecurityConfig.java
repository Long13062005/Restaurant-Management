...
import com.example.restaurantmanagement.security.filters.JwtAuthenticationFilter;
import com.example.restaurantmanagement.security.filters.RefreshTokenFilter;
        ...
        return http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(
                        req -> req
                                ...
                                .requestMatchers("/adminemp/**").hasAnyAuthority("ADMIN", "EMPLOYEE")
